...
if not is_momod(msg) then
	...
	if msg.text then
		filterHash = "hadanet:cli:filtered:"..msg.to.id
	...
	if msg.media then
		...
		if msg.fwd_from then
			...
			elseif msg.fwd_from.title then
				-- lock link
				local is_link_title = msg.fwd_from.title:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.fwd_from.title:match("[Tt]][Mm].[Mm][Ee]/") or msg.fwd_from.title:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.fwd_from.title:match("[Hh][Tt][Tt][Pp]://")
			...
			-- lock link
			local is_link_msg = msg.text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.text:match("[Tt][Mm].[Mm][Ee]/") or msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://")
		...
		if msg.media then -- msg.media checks
			...
			if msg.media.title then
				...
				-- lock link
				local is_link_title = msg.media.title:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.media.title:match("[Tt][Mm].[Mm][Ee]/") or msg.media.title:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.media.title:match("[Hh][Tt][Tt][Pp]://")
				if is_link_title and lock_link == "yes" then
					delete_msg(msg.id, ok_cb, false)
					if lock_strict == "yes" then
						kick_user(msg.from.id,msg.to.id)
			...
			if msg.media.description then
				...
				-- lock link
				local is_link_desc = msg.media.description:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.media.description:match("[Tt][Mm].[Mm][Ee]/") or msg.media.description:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.media.description:match("[Hh][Tt][Tt][Pp]://")
			...
			if msg.media.caption then -- msg.media.caption checks
				...
				-- lock link
				local is_link_caption = msg.media.caption:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.media.caption:match("[Tt][Mm].[Mm][Ee]/") or msg.media.caption:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.media.caption:match("[Hh][Tt][Tt][Pp]://")
